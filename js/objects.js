...
let person = {
    ...
    greeting: function() {
        alert(`Hi there! My name is ${this.name.firstName} ${this.name.lastName}.`);
    },
    bio: function() {
...
person.goodbye = function() {
    alert(`Goodbye from ${this.name.firstName} ${this.name.lastName}!`);
};
...
outputElement.innerHTML = `Name: ${name}, Age: ${age}, Gender: ${gender}`;
